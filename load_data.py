...
dup_col_prg = programs.columns[programs.columns.duplicated()].tolist()
# duplicate_columns.extend(programs.columns[programs.columns.duplicated()].tolist())
if dup_col_prg:
    print("Duplicate columns:", dup_col_prg)
else:
