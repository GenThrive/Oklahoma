...
# PAGE SETTINGS
# ----------------------------------------------------------------------------
app_title = 'Oklahoma Environmental Education Directory'
page_title = 'Oklahoma Environmental Education Directory'
sub_title = 'Filter on'
...
# MAP SETTINGS
# ----------------------------------------------------------------------------
map_center_lat = 35.2803662
map_center_lon = -101.356304
map_zoom = 5.072
